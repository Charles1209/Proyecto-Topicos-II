            ...
            <Card>
              <Card.Body>
                <Form onSubmit={handleSubmit}>
                  ...
                  <h3 className="text-center">Verifique su correo electrónico</h3>
                  {message && (
                    <div
                  ...
                  Ingrese su dirección de correo electrónico a continuación para recibir un enlace de activación.
                  </p>
                  <Form.Group>
                    <Form.Label htmlFor="email">Ingrese email:</Form.Label>
